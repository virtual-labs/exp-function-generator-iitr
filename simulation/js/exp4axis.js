...
function mainswt() {
    ...
    if (bttn == "Power:Off") {
        ...
        document.getElementById("chhn3").disabled = false;
        ...
        document.getElementById("P3").value = 90;
...
function drawAxis() {
    ...
    voltperdiv1 = document.getElementById("P1").value;
    vmaxs1 = parseFloat(voltperdiv1) * 4;//volt 
    voltperdiv2 = document.getElementById("P1").value;
